...
export default function AdminLogin() {
  ...
  const submit = async (event) => { event.preventDefault(); setBusy(true); setError(''); const result = await login(email, password); setBusy(false); if (result.error) { setError('Invalid administrator credentials.'); return; } };
